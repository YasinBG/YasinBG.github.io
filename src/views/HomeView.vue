<template>
   <div class=" bg-cover w-full h-full mx-auto" style="background-image: url('https://cdn.pixabay.com/photo/2017/07/07/02/06/symbol-2480163_1280.png'); ">
  <div class=" w-1/3 flex flex-col justify-center mx-auto "
    ...
    <ul class="flex justify-center flex-col my-6" v-for="(task, index) in tasks" :key="index">
      <li class="flex justify-center mx-auto font-semibold">
        ...
        <div class="fixed ml-60">
          ...
          >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="text-red-400 w-6 h-6">
